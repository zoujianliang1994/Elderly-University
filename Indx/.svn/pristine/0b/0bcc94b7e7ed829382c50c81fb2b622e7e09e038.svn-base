		...
		<form action="${MSG}.do" class="layui-form" id="editForm" lay-filter="editForm" method="post">
			 ...
			 <div class="layui-form-item">
			 	 <div class="form-item-inline">
				   ...
				   <div class="layui-input-block ">
				      <input type="text" readonly="readonly"  style="padding: 7px; "placeholder="${null == pds.MENU_NAME ?'(无) 此项为顶级菜单':pds.MENU_NAME}" class="layui-input layui-input-color" />
				    </div>
				  </div>
				 <div class="form-item-inline">
					<label class="form-label">名称</label>
					<div class="layui-input-block ">
					  <input type="text" value="${pd.MENU_NAME }" name="MENU_NAME" required  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input layui-input-color" >
					</div>
				 </div>
			  </div>
			   <div class="layui-form-item">
						...
						<div class="layui-input-block ">
							...
							<div class="col-sm-9">
								<c:if test="${null != pds.MENU_NAME}">
									...
									<input type="text" name="MENU_URL" id="menuUrl" value="${pd.MENU_URL }" autocomplete="off" placeholder="这里输入菜单链接"  required  lay-verify="required" class="layui-input layui-input-color" />
								</c:if>
								<c:if test="${null == pds.MENU_NAME}">
									<input type="text" name="MENU_URL" id="menuUrl" value="" readonly="readonly" placeholder="顶级菜单禁止输入"   required  lay-verify="required" class="layui-input layui-input-color"  />
								</c:if>
							</div>
				   ...
				   <div class="form-item-inline">
					  ...
					  <div class="layui-input-block ">
						   <input required  lay-verify="required" type="number" name="MENU_ORDER" id="menuOrder" value="${pd.MENU_ORDER}" placeholder="这里输入菜单序号" title="请输入正整数" autocomplete="off" class="layui-input layui-input-color" >
					   </div>
				   </div>
			  </div>
			...
			<div class="layui-form-item">
				<div class="form-item-inline">
					...
					<div class="layui-input-block ">
						<input required  lay-verify="required" type="text" name="MENU_ICON" id="MENU_ICON" value="${pd.MENU_ICON}" placeholder="这里输入菜单图标" autocomplete="off" class="layui-input layui-input-color" >
					</div>
				</div>
			</div>
