 ...
 * 解析Excel
 */
public class ObjectExcelReadOther {
  ...
  public ObjectExcelReadOther(String filepath, String filename, int startrow, int startcol, int endRow, int numSheet) {
   ...
   * 解析Excel并且返回内容
   */
  private List<Object> getWorkBook(Workbook workbook, int startrow, int startcol, int endRow, int numSheet) {
    String[] arrs;
    ...
    try {
      ...
      for (int rowIndex = firstRowIndex; rowIndex <= lastRowIndex; rowIndex++) {
        ...
        if (currentRow != null) {
          ...
          arrs = new String[lastColumnIndex + 1];
          arrs[0] = "";
          for (int columnIndex = firstColumnIndex; columnIndex <= lastColumnIndex; columnIndex++) {
            ...
            arrs[columnIndex] = currentCellValue;
