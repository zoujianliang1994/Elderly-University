...
<div class="tableBox">
    <div class="operationBox">
        ...
        <form action="list.do" method="post" class="layui-form" name="Form" id="Form">
            <div class=" fl ">
                <input id="keywords" name="keywords" type="text" value="${pd.keywords}" placeholder="请输入分校、教学点名称" class="layui-input fl search layui-input-color">
    ...
    <div class="layui-col-sm12">
        <table class="layui-table center" lay-skin="line" id="table">
            ...
            <tr class="table-head-tr">
                ...
                <th>联系人</th>
                <th>联系电话</th>
                <th style="width: 200px; border-left: 1px solid #dce3eb;">操作</th>
            </tr>
            </thead>
            <tbody>
            <c:choose>
