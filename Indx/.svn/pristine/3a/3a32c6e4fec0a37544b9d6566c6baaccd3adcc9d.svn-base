...
public class MessageService implements MessageManager{
	...
	public List<PageData> listAllMessage(Page page) throws Exception {
		return (List<PageData>)dao.findForList("MessageMapper.allMessagelistPage", page);
	}
