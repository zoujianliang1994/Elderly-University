...
public class BigExcelReader {
   ...
   * @throws SAXException
   */
  public BigExcelReader(String filename, int sheetindex) throws IOException, OpenXML4JException, SAXException {
   ...
   * @throws SAXException
   */
  public BigExcelReader(File file, int sheetindex) throws IOException, OpenXML4JException, SAXException {
   ...
   * @throws SAXException
   */
  public BigExcelReader(InputStream in, int sheetindex) throws IOException, OpenXML4JException, SAXException {
   ...
   * @throws SAXException
   */
  private void init(OPCPackage pkg, int sheetindex) throws IOException, OpenXML4JException, SAXException {
    XSSFReader xssfReader = new XSSFReader(pkg);
    SharedStringsTable sharedStringsTable = xssfReader.getSharedStringsTable();
    StylesTable stylesTable = xssfReader.getStylesTable();
    String st = "rId" + (sheetindex + 1);
    sheet = xssfReader.getSheet(st);
        ...
        switch (this.dataType) {
          ...
          case NUMBER: {
            ...
            if (HSSFDateUtil.isADateFormat(formatIndex, readValue)) {
              ...
              rowDatas[colIdx] = new SimpleDateFormat(DATE_FORMAT_STR).format(date);
