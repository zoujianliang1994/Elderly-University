...
import com.zhimu.commons.constant.ClassConstant;
...
public class MyClassService implements MyClassManager {
	...
	public List<PageData> listPage(Page page) throws Exception {
		...
		if (StringUtils.isNotBlank(peopleType) && ClassConstant.OTHER_TEACHER.getName().equals(peopleType)){
			return (List<PageData>) dao.findForList("MyClassMapper.listPageTeacher", page);
		}else if (StringUtils.isNotBlank(peopleType) && ClassConstant.HEAD_TEACHER.getName().equals(peopleType)){
