...
<div class="edit_menu" class="disnone">
	...
	<form action="activityGroup/check.do" class="layui-form" name="form1" id="form1" method="post">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline" style="width:98%">
					<label class="form-label label-max">居住地址</label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline">
					<label class="form-label label-max">家庭联系人</label>
					<div class="layui-input-block ">
				...
				<div class="form-item-inline">
					<label class="form-label label-max">联系人电话</label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline">
					<label class="form-label label-max">第二联系人</label>
					<div class="layui-input-block ">
	...
	<c:if test="${pd.operation == 'check'}">
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline" style="width:98%;">
					<label class="form-label label-max" >审核意见</label>
					<div class="layui-input-block " >
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#sure,#notsure").on("click",function(){
                ...
                var activity_id ="${personalInfo.activity_id}";
