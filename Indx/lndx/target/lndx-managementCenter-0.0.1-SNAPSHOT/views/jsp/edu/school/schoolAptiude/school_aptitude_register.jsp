        ...
        <div class="school-info-form-right">
            <div class="school-info-form-right-wirte">
                ...
                <form action="${msg}.do" class="layui-form" id="editForm" enctype="multipart/form-data" lay-filter="editForm" method="post" style="text-align: center;">
                    ...
                    <div class="layui-form-item" style="padding-bottom: 4px;">
                        ...
                        <div class="layui-form-item">
                            <div class="form-item-inline1">
                                <div class="form-small-inline1">
                                   ...
                                   <div class="layui-input-block  is-subordinate" style="width:9rem;">
                                ...
                                <div class="form-small-inline">
                                   ...
                                   <div class="layui-input-block " style="width: 8rem;">
                            ...
                            <div class="form-item-inline">
                                <div class="form-small-inline1">
                                   ...
                                   <div class="layui-input-block  is-teaching" style="width: 9rem;">
                ...
                <div class="btnbox" id="btnDiv" style="margin-bottom: 120px">
...
<script type="text/javascript">
    $.myUploading("schoolFile",100,200)
