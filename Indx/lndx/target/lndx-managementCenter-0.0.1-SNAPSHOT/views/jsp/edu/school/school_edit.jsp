...
<div class="edit_menu" class="disnone">
    <form action="${msg}.do" class="layui-form" id="editForm" lay-filter="editForm" method="post">
        ...
        <input type="hidden" value="${pd.pid}" name="pid" id="pid"/>
		...
		<div class="layui-form-item">
			<div class="layui-row">
				...
				<div class="form-item-inline">
					<label class="form-label " ><i class="require">*</i>联系人</label>
					<div class="layui-input-block ">
							<input type="text" value="${pd.contact}" name="contact" id="contact" required lay-verify="required" placeholder="请输入联系人姓名"
