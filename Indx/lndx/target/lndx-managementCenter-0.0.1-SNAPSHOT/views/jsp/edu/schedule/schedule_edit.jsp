	...
	<form action="schedule/${msg}.do" class="layui-form"  name="form1" id="form1" >
		...
		<div class="layui-form-item">
			<div class="layui-row">
				...
				<div class="form-item-inline">
					<label class="form-label title-max" style="width: 100px"><span>所属校区</span><span>/教学点</span></label>
		...
		<div class="layui-form-item">
			<div class="layui-row">
				...
				<div class="form-item-inline">
					<label class="form-label title-max"><span><span class="red-star">*</span>课间休息</span><span>时间(分)</span> </label>
				...
				<div class="form-item-inline">
					<label class="form-label"><span class="red-star">*</span>午休时间<span>(分)</span></label>
					<div class="layui-input-block ">
