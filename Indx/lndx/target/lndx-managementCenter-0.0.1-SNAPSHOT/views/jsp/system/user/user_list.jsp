...
<div class="tableBox">
    <div class="operationBox">
        ...
        <form action="listUsers.do" method="post" class="layui-form" name="Form" id="Form">
            ...
            <%--<div class=" fl marL-20">
            <input id="keywords" name="keywords" type="text" value="${pd.keywords}" placeholder="请输入姓名" class="layui-input fl search">
            <div class="fl srarchBtn" onclick="gsearch()">
                <i class="iconfont icon-sousuo"></i>
            </div>
        </div>--%>
                <div class=" fl">
                    <input value="${pd.keywords }"  id="keywords" name="keywords"   type="text" placeholder="请输入姓名" class="layui-input fl search layui-input-color">
                    ...
                    <shiro:hasPermission name="system:user:select">
                        <c:forEach items="${userList}" var="var" varStatus="vs">
                            <tr>
                                ...
                                <%--</td>--%>
                                <td style="text-align: center;width: 200px;border-left: 1px solid #dce3eb;">
                                    <shiro:hasPermission name="system:user:select">
                                        <a class="table-btn chakan-btn " onclick="edit('${var.USER_ID}','1');">
                                    ...
                                    <shiro:hasPermission name="system:user:edit">
                                   		<c:if test="${var.IS_PARTY == '0'||userName=='admin'}">
                                          	<a class="table-btn bianji-btn edit" onclick="edit('${var.USER_ID}','2');">
                                    ...
                                    <shiro:hasPermission name="system:user:delete">
                                        <c:if test="${var.IS_PARTY == '0'||userName=='admin'}">
                                            <a class="table-btn shanchu-btn del" onclick="del('${var.USER_ID}');">
