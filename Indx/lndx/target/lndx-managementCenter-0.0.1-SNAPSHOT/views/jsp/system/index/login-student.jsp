...
<div class="loginbody">
    <div class="earthbg">
        <img class="wh100" src="<%=basePath%>static/source/public/images/login-pay.jpg"/>
    </div>

    <div class="mapbg"></div>
    <div class="loginBox">
        <p class="title-student">XX大学网上报名</p>
        <div class="input-group">
            <label class="username ">姓名</label>
            <input class="login-input fl " id="user" placeholder="用户名" maxlength="20"/>
        </div>
        <div class="input-group">
            <label class="password">身份证号</label>
            <input class="login-input fl" id="password" placeholder="密码" type="password" maxlength="20"/>
        </div>
        <div class="login-btn" id="login">登&nbsp;&nbsp;录</div>
        <div style="margin-top: 20px;text-align: center;color: #fff;opacity: 0.7;">
            <a style="color: #fff;cursor: pointer;">立即注册</a>
        </div>
    </div>
</div>
