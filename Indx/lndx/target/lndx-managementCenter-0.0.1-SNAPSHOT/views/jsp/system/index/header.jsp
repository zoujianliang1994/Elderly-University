        ...
        <div class="sayhi">
            <%--<span class="time"></span>--%>
                <a href="javascript:void(0);">
                    ...
                    <span class="iconfont icon-fold-copy"></span>
                    <span class="iconfont icon-fold" hidden></span>
                </a>
                <dl class="nav-child" style="text-align:center">
                    <dd>
                        <a id="updatePw" href="javascript:">修改密码</a>
                    </dd>
                    <dd>
                        <a  href="javascript:message()">个人消息</a>
                    </dd>
                    <dd onclick="logOut();">
...
<script type="text/javascript">
    ...
    $(".sayhi a").click(function(){
        $(".nav-child").toggle();
        $(".icon-fold-copy").toggle();
        $(".icon-fold").toggle();
    });
