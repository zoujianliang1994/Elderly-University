    ...
    <form action="${msg}.do" class="layui-form" id="editForm" lay-filter="editForm" method="post">
        ...
        <div class="layui-form-item" id="mimaDiv">
            <div class="layui-row">
                ...
                <div class="form-item-inline isPasswordLook">
                    <label class="form-label"><i class="require isEdit">*</i>密码<span class="colon"></span></label>
                   <div class="layui-input-block ">
                ...
                <div class="form-item-inline isPasswordLook">
                    <label class="form-label"><i class="require isEdit">*</i>确认密码<span class="colon"></span></label>
                   <div class="layui-input-block ">
        ...
        <div class="layui-form-item">
            <div class="layui-row">
                ...
                <div class="form-item-inline" style="width: 98%;">
                   ...
                   <div class="layui-input-block">
                        <div id="sTree" class="sTree layui-textarea"></div>
                    </div>
                </div>
            </div>
        </div>
