...
<body>
<div class="edit_menu">
    <form action="" class="layui-form" id="editForm" lay-filter="editForm" method="post" style="width: 300px;margin: auto;">
        <input type="hidden" value="${pd.USERNAME}" name="USERNAME" id="USERNAME"/>
        <%--<div class="layui-form-item">--%>

            <%--<label class="layui-form-label">姓名：</label>--%>
            <%--<div class="layui-input-block ">--%>
                <%--<input type="text" value="${pd.NAME }" name="NAME" id="NAME" readonly style="background-color: #f2f2f2;width: 15rem;"--%>
                       <%--autocomplete="off"--%>
                       <%--class="layui-input">--%>
            <%--</div>--%>
        <%--</div>--%>
        ...
        <div class="layui-form-item">
            ...
            <label class="layui-form-label" style="color: #333;width: 70px;"><span class="red-star">*</span>旧密码</label>
           <div class="layui-input-block ">
                <input type="password" name="PASSWORD" id="PASSWORD" required lay-verify="required" placeholder="请输入旧密码"
                       autocomplete="off"
                       class="layui-input" style="width: 15rem;">
            </div>
        </div>

        <div class="layui-form-item">

            <label class="layui-form-label"  style="color: #333;width: 70px;"><span class="red-star">*</span>新密码</label>
           <div class="layui-input-block ">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"  style="color: #333;width: 70px;"><span class="red-star">*</span>确认密码</label>
           <div class="layui-input-block ">
