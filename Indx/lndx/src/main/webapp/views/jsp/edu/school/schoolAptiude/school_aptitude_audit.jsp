...
<div class="edit_menu" class="disnone">
    <form action="${msg}.do" class="layui-form" id="editForm"  lay-filter="editForm" method="post">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>联系人姓</span><span>名</span></label>
					<div class="layui-input-block ">
				...
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>联系人联</span><span>系电话</span></label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>联系人邮</span><span>箱</span></label>
					<div class="layui-input-block ">
				...
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>学员总人</span><span>数</span></label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				...
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>是否存在</span><span>分校</span></label>
		...
		<div class="layui-form-item">
			<div class="layui-row">
				<div class="form-item-inline">
					<label class="form-label title-max"><span><i class="require">*</i>税务登记</span><span>号</span></label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
	             <div class="form-item-inline">
					 <label class="form-label title-max"><span><i class="require">*</i>是否存在</span><span>教学点</span></label>
	             ...
	             <div class="form-item-inline">
					 <label class="form-label title-max"><span>教学点个</span><span>数</span></label>
					<div class="layui-input-block ">
		...
		<div class="layui-form-item">
			<div class="layui-row">
				 <div class="form-item-inline">
					 <label class="form-label title-max"><span><i class="require">*</i>是否民政</span><span>部注册</span></label>
		...
		<div class="layui-form-item">
			...
			<label class="form-label title-max"><span>上传营业</span><span>执照</span></label>
			<c:choose>
    ...
    <div class="btnbox" id="btnDiv" style="margin-top: 5rem;">
			...
			<button id="cancel" class="layui-btn layui-btn-primary layui-btn-small" style="width: 8rem;height: 3rem;" onclick="audit('NO');">不同意</button>
		</div>
