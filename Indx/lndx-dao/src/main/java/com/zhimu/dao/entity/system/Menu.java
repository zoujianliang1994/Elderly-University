...
public class Menu implements Comparable<Menu> {
	...
	public String toString() {
		return "Menu [MENU_ID=" + MENU_ID + ", MENU_NAME=" + MENU_NAME + ", MENU_URL=" + MENU_URL + ", PARENT_ID=" + PARENT_ID + ", MENU_ORDER=" + MENU_ORDER + ", MENU_ICON=" + MENU_ICON
				+ ", MENU_TYPE=" + MENU_TYPE + ", MENU_STATE=" + MENU_STATE + ", target=" + target + ", hasMenu=" + hasMenu + "]";
	}
	...
	public int compareTo(Menu o) {
		...
		// 按照学生的年龄进行升序排列
		if (Integer.parseInt(this.getMENU_ORDER()) > Integer.parseInt(o.getMENU_ORDER())) {
			return 1;
		}
		if (this.getMENU_ORDER().equals(o.getMENU_ORDER())) {
			return 0;
		}
